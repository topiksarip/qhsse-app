...
|---|---:|---|---|---|
| Core Foundation | 0 | Planned | - | QHSSE/Admin |
| Dashboard & KPI | 1 | Planned | Core Foundation, semua modul sumber data | QHSSE/Admin |
| Incident / Accident / Near Miss Reporting | 2 | Planned | Core Foundation, Master Data, File Upload, Notification, Workflow | QHSSE/Admin |
...
| Security Management | 11 | Planned | Core Foundation, Incident, Inspection, Contractor | QHSSE/Admin |
| Quality Management | 12 | Planned | Core Foundation, CAPA, Audit, Document, Asset | QHSSE/Admin |
...
| Admin & Master Data | 20 | Planned | Core Foundation, semua modul | QHSSE/Admin |
