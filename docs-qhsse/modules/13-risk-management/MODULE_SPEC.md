...
Modul Risk Management / HIRADC / JSA mengelola proses QHSSE terkait `Risk Management / HIRADC / JSA` secara end-to-end, terintegrasi dengan Core Foundation: user, role, permission, master data, file upload, notification, numbering, workflow, audit trail, comments, dashboard, dan reporting.

## 2. Dependency

Core Foundation, Document, CAPA, Incident, PTW
