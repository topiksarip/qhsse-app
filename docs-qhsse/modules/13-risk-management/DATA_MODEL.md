...
- `13_risk_management_items` for line/detail rows if needed.
- `13_risk_management_approvals` for multi-approval if needed.
- `13_risk_management_histories` optional if module-specific history is needed.
