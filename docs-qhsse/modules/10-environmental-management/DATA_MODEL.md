...
- `10_environmental_management_items` for line/detail rows if needed.
- `10_environmental_management_approvals` for multi-approval if needed.
- `10_environmental_management_histories` optional if module-specific history is needed.
