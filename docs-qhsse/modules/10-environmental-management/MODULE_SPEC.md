...
Modul Environmental Management mengelola proses QHSSE terkait `Environmental Management` secara end-to-end, terintegrasi dengan Core Foundation: user, role, permission, master data, file upload, notification, numbering, workflow, audit trail, comments, dashboard, dan reporting.

## 2. Dependency

Core Foundation, CAPA, Legal, Document
...
- `environmental-management.create`
- `environmental-management.update`
- `environmental-management.submit`
- `environmental-management.review`
- `environmental-management.approve`
- `environmental-management.reject`
- `environmental-management.verify`
- `environmental-management.close`
- `environmental-management.reopen`
- `environmental-management.export`
