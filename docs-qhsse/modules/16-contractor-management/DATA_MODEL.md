...
- `16_contractor_management_items` for line/detail rows if needed.
- `16_contractor_management_approvals` for multi-approval if needed.
- `16_contractor_management_histories` optional if module-specific history is needed.
