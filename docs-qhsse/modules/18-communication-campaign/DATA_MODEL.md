...
- `18_communication_campaign_items` for line/detail rows if needed.
- `18_communication_campaign_approvals` for multi-approval if needed.
- `18_communication_campaign_histories` optional if module-specific history is needed.
