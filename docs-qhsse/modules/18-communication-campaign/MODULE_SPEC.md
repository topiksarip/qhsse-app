...
Modul Communication & Campaign mengelola proses QHSSE terkait `Communication & Campaign` secara end-to-end, terintegrasi dengan Core Foundation: user, role, permission, master data, file upload, notification, numbering, workflow, audit trail, comments, dashboard, dan reporting.

## 2. Dependency

Core Foundation, Notification, Document, Training
...
- `communication-campaign.view`
- `communication-campaign.create`
- `communication-campaign.update`
- `communication-campaign.submit`
- `communication-campaign.review`
- `communication-campaign.approve`
- `communication-campaign.reject`
- `communication-campaign.verify`
- `communication-campaign.close`
- `communication-campaign.reopen`
- `communication-campaign.export`
