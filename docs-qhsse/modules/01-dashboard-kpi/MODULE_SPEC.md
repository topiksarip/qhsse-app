...
Modul Dashboard & KPI mengelola proses QHSSE terkait `Dashboard & KPI` secara end-to-end, terintegrasi dengan Core Foundation: user, role, permission, master data, file upload, notification, numbering, workflow, audit trail, comments, dashboard, dan reporting.

## 2. Dependency

Core Foundation, semua modul sumber data
...
- KPI cards
- Trend charts
- Filters by site/department/date
- Overdue action widget
- Incident heatmap
- Export dashboard
...
- `dashboard-kpi.submit`
- `dashboard-kpi.review`
- `dashboard-kpi.approve`
- `dashboard-kpi.reject`
- `dashboard-kpi.verify`
- `dashboard-kpi.close`
- `dashboard-kpi.reopen`
