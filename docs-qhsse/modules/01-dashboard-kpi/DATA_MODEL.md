...
- `01_dashboard_kpi_items` for line/detail rows if needed.
- `01_dashboard_kpi_approvals` for multi-approval if needed.
- `01_dashboard_kpi_histories` optional if module-specific history is needed.
