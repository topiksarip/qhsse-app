...
- `06_audit_management_items` for line/detail rows if needed.
- `06_audit_management_approvals` for multi-approval if needed.
- `06_audit_management_histories` optional if module-specific history is needed.
