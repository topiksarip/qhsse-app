...
Modul Audit Management mengelola proses QHSSE terkait `Audit Management` secara end-to-end, terintegrasi dengan Core Foundation: user, role, permission, master data, file upload, notification, numbering, workflow, audit trail, comments, dashboard, dan reporting.

## 2. Dependency

Core Foundation, CAPA, Document, Legal
...
- `audit-management.submit`
- `audit-management.review`
- `audit-management.approve`
- `audit-management.reject`
- `audit-management.verify`
- `audit-management.close`
- `audit-management.reopen`
