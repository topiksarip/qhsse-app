...
Modul Inspection Checklist mengelola proses QHSSE terkait `Inspection Checklist` secara end-to-end, terintegrasi dengan Core Foundation: user, role, permission, master data, file upload, notification, numbering, workflow, audit trail, comments, dashboard, dan reporting.

## 2. Dependency

Core Foundation, CAPA, Asset, Contractor
...
- `inspection-checklist.create`
- `inspection-checklist.update`
- `inspection-checklist.submit`
- `inspection-checklist.review`
- `inspection-checklist.approve`
- `inspection-checklist.reject`
- `inspection-checklist.verify`
- `inspection-checklist.close`
- `inspection-checklist.reopen`
- `inspection-checklist.export`
