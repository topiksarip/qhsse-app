...
- `05_inspection_checklist_items` for line/detail rows if needed.
- `05_inspection_checklist_approvals` for multi-approval if needed.
- `05_inspection_checklist_histories` optional if module-specific history is needed.
