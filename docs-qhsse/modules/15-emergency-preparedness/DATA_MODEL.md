...
- `15_emergency_preparedness_items` for line/detail rows if needed.
- `15_emergency_preparedness_approvals` for multi-approval if needed.
- `15_emergency_preparedness_histories` optional if module-specific history is needed.
