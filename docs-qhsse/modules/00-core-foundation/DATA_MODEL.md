...
- `00_core_foundation_items` for line/detail rows if needed.
- `00_core_foundation_approvals` for multi-approval if needed.
- `00_core_foundation_histories` optional if module-specific history is needed.
