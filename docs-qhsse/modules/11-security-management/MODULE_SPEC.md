...
Modul Security Management mengelola proses QHSSE terkait `Security Management` secara end-to-end, terintegrasi dengan Core Foundation: user, role, permission, master data, file upload, notification, numbering, workflow, audit trail, comments, dashboard, dan reporting.

## 2. Dependency

Core Foundation, Incident, Inspection, Contractor
...
- `security-management.submit`
- `security-management.review`
- `security-management.approve`
- `security-management.reject`
- `security-management.verify`
- `security-management.close`
- `security-management.reopen`
- `security-management.export`
