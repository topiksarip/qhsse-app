...
- `17_asset_equipment_safety_items` for line/detail rows if needed.
- `17_asset_equipment_safety_approvals` for multi-approval if needed.
- `17_asset_equipment_safety_histories` optional if module-specific history is needed.
