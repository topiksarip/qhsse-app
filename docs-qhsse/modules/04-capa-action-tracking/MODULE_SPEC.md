# Module Spec — CAPA / Corrective & Preventive Action

## 1. Tujuan Modul

Modul CAPA / Corrective & Preventive Action mengelola proses QHSSE terkait `CAPA / Corrective & Preventive Action` secara end-to-end, terintegrasi dengan Core Foundation: user, role, permission, master data, file upload, notification, numbering, workflow, audit trail, comments, dashboard, dan reporting.

## 2. Dependency

Core Foundation, Incident, Inspection, Audit, Risk, Legal
...
- `capa-action-tracking.view`
- `capa-action-tracking.create`
- `capa-action-tracking.update`
- `capa-action-tracking.submit`
- `capa-action-tracking.review`
- `capa-action-tracking.approve`
- `capa-action-tracking.reject`
- `capa-action-tracking.verify`
- `capa-action-tracking.close`
- `capa-action-tracking.reopen`
- `capa-action-tracking.export`
