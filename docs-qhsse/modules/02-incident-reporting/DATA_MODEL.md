...
- `02_incident_reporting_items` for line/detail rows if needed.
- `02_incident_reporting_approvals` for multi-approval if needed.
- `02_incident_reporting_histories` optional if module-specific history is needed.
