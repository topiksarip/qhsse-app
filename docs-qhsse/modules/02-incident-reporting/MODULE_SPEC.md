# Module Spec — Incident / Accident / Near Miss Reporting

## 1. Tujuan Modul

Modul Incident / Accident / Near Miss Reporting mengelola proses QHSSE terkait `Incident / Accident / Near Miss Reporting` secara end-to-end, terintegrasi dengan Core Foundation: user, role, permission, master data, file upload, notification, numbering, workflow, audit trail, comments, dashboard, dan reporting.

## 2. Dependency

Core Foundation, Master Data, File Upload, Notification, Workflow
...
- `incident-reporting.approve`
- `incident-reporting.reject`
- `incident-reporting.verify`
- `incident-reporting.close`
- `incident-reporting.reopen`
