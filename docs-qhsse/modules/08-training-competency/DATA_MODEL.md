...
- `08_training_competency_items` for line/detail rows if needed.
- `08_training_competency_approvals` for multi-approval if needed.
- `08_training_competency_histories` optional if module-specific history is needed.
