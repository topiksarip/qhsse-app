...
Modul Training & Competency mengelola proses QHSSE terkait `Training & Competency` secara end-to-end, terintegrasi dengan Core Foundation: user, role, permission, master data, file upload, notification, numbering, workflow, audit trail, comments, dashboard, dan reporting.

## 2. Dependency

Core Foundation, Employee, Contractor, Notification
...
- `training-competency.view`
- `training-competency.create`
- `training-competency.update`
- `training-competency.submit`
- `training-competency.review`
- `training-competency.approve`
- `training-competency.reject`
- `training-competency.verify`
- `training-competency.close`
- `training-competency.reopen`
- `training-competency.export`
