# Data Model — Admin & Master Data

## Main Table

`20_admin_master_data`
...
- `20_admin_master_data_items` for line/detail rows if needed.
- `20_admin_master_data_approvals` for multi-approval if needed.
- `20_admin_master_data_histories` optional if module-specific history is needed.
