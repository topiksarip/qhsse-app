...
- `07_document_control_items` for line/detail rows if needed.
- `07_document_control_approvals` for multi-approval if needed.
- `07_document_control_histories` optional if module-specific history is needed.
