...
- `12_quality_management_items` for line/detail rows if needed.
- `12_quality_management_approvals` for multi-approval if needed.
- `12_quality_management_histories` optional if module-specific history is needed.
