...
Modul Quality Management mengelola proses QHSSE terkait `Quality Management` secara end-to-end, terintegrasi dengan Core Foundation: user, role, permission, master data, file upload, notification, numbering, workflow, audit trail, comments, dashboard, dan reporting.

## 2. Dependency

Core Foundation, CAPA, Audit, Document, Asset
...
- `quality-management.submit`
- `quality-management.review`
- `quality-management.approve`
- `quality-management.reject`
- `quality-management.verify`
- `quality-management.close`
- `quality-management.reopen`
- `quality-management.export`
