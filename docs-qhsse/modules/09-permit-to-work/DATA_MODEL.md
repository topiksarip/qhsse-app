...
- `09_permit_to_work_items` for line/detail rows if needed.
- `09_permit_to_work_approvals` for multi-approval if needed.
- `09_permit_to_work_histories` optional if module-specific history is needed.
