...
Modul Permit to Work mengelola proses QHSSE terkait `Permit to Work` secara end-to-end, terintegrasi dengan Core Foundation: user, role, permission, master data, file upload, notification, numbering, workflow, audit trail, comments, dashboard, dan reporting.

## 2. Dependency

Core Foundation, Risk/JSA, Contractor, Training, Asset, Notification
...
- `permit-to-work.view`
- `permit-to-work.create`
- `permit-to-work.update`
- `permit-to-work.submit`
- `permit-to-work.review`
- `permit-to-work.approve`
- `permit-to-work.reject`
- `permit-to-work.verify`
- `permit-to-work.close`
- `permit-to-work.reopen`
- `permit-to-work.export`
