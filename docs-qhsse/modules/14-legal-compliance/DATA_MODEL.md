...
- `14_legal_compliance_items` for line/detail rows if needed.
- `14_legal_compliance_approvals` for multi-approval if needed.
- `14_legal_compliance_histories` optional if module-specific history is needed.
