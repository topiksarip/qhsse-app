# Data Model — Reporting & Export Advanced
...
- `19_reporting_export_items` for line/detail rows if needed.
- `19_reporting_export_approvals` for multi-approval if needed.
- `19_reporting_export_histories` optional if module-specific history is needed.
