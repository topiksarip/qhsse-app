# Module Spec — Reporting & Export Advanced

## 1. Tujuan Modul

Modul Reporting & Export Advanced mengelola proses QHSSE terkait `Reporting & Export Advanced` secara end-to-end, terintegrasi dengan Core Foundation: user, role, permission, master data, file upload, notification, numbering, workflow, audit trail, comments, dashboard, dan reporting.

## 2. Dependency

Core Foundation, Dashboard, semua modul
...
- `reporting-export.view`
- `reporting-export.create`
- `reporting-export.update`
- `reporting-export.submit`
- `reporting-export.review`
- `reporting-export.approve`
- `reporting-export.reject`
- `reporting-export.verify`
- `reporting-export.close`
- `reporting-export.reopen`
