...
- `03_investigation_rca_items` for line/detail rows if needed.
- `03_investigation_rca_approvals` for multi-approval if needed.
- `03_investigation_rca_histories` optional if module-specific history is needed.
