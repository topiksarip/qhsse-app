...
Modul Investigation & RCA mengelola proses QHSSE terkait `Investigation & RCA` secara end-to-end, terintegrasi dengan Core Foundation: user, role, permission, master data, file upload, notification, numbering, workflow, audit trail, comments, dashboard, dan reporting.

## 2. Dependency

Core Foundation, Incident Reporting, CAPA
...
- `investigation-rca.view`
- `investigation-rca.create`
- `investigation-rca.update`
- `investigation-rca.submit`
- `investigation-rca.review`
- `investigation-rca.approve`
- `investigation-rca.reject`
- `investigation-rca.verify`
- `investigation-rca.close`
- `investigation-rca.reopen`
- `investigation-rca.export`
