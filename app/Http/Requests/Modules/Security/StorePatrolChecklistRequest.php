...
class StorePatrolChecklistRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()->can('create', PatrolChecklist::class);
    }
    ...
    public function after(): array
    {
        return [function ($validator): void {
            ...
            if (! $user->can('core.scope.all') && $user->employee?->site_id !== $this->integer('site_id')) {
                $validator->errors()->add('site_id', 'Anda hanya dapat membuat patroli untuk site yang menjadi scope Anda.');
            }
    ...
    {
        return [
            'title' => 'rute/judul patroli',
            'site_id' => 'site',
            'area_id' => 'area',
            'scheduled_at' => 'jadwal patroli',
            'assigned_to' => 'petugas patroli',
            'checkpoints' => 'checkpoint',
            'checkpoints.*.checkpoint' => 'nama checkpoint',
        ];
    }
}
