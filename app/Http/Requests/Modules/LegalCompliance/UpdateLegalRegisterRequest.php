...
class UpdateLegalRegisterRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()->can('legal.register.update');
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'compliance_status' => ['required', 'string', 'in:compliant,non_compliant,in_progress,not_applicable'],
    ...
    public function messages(): array
    {
        return [
            ...
            'compliance_status.required' => 'Status kepatuhan wajib dipilih.',
