...
final class CorePermissions
{
    ...
    public static function roleMap(): array
    {
        ...
        $inspectionCreateExecute = ['inspection.checklists.view', 'inspection.checklists.create', 'inspection.checklists.execute', 'inspection.checklists.export'];
        ...
        return [
            ...
            'Foreman' => ['core.scope.department', 'core.employees.view', ...$incidentSupervisor, ...$investigationView, ...$capaView, ...$inspectionCreateExecute, ...$documentView, ...$auditView, ...$trainingViewExport, ...$riskView, ...$emergencyCreate, ...$permitView, ...$environmentView, ...$securityView, ...$qualityView, ...$assetViewExport, ...$apdViewExport, ...$communicationView],
            'Operator' => ['core.scope.department', ...$incidentBasic, ...$investigationView, ...$capaView, ...$inspectionCreateExecute, ...$documentView, ...$auditView, ...$trainingViewExport, ...$riskView, ...$emergencyView, ...$permitView, ...$environmentView, ...$securityView, ...$qualityView, ...$assetView, ...$apdView, ...$communicationView],
